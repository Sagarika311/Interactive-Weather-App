  ...
  return (
    <div className="glass-card relative p-6">
      ...
      <div className="relative">
        ...
        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scroll-smooth py-2 px-1 scrollbar-thin scrollbar-thumb-gray-400/40 dark:scrollbar-thumb-gray-600/40">
          {data.time.slice(0, sliceCount).map((time, idx) => {
            ...
            return (
              <motion.div
                ...
                className="snap-center min-w-[110px] h-[130px] rounded-2xl bg-white/60 dark:bg-black/40 shadow-md 
